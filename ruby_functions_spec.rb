...
#   #Further
  ...
  def test_volume_of_cube()
    cube_1 = volume_of_cube(5)
    cube_2 = volume_of_cube(3)

    assert_equal(125, cube_1)
    assert_equal(27, cube_2)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    sphere_1 = volume_of_sphere(2)
    sphere_2 = volume_of_sphere(3)

    assert_equal(33, sphere_1)
    assert_equal(112, sphere_2)
  end

#   #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
      test_1 = fahrenheit_to_celsius(100)
      test_2 = fahrenheit_to_celsius(70)
      assert_equal(37, test_1)
      assert_equal(21, test_2)
  end
